...
//
//    private final JwtTokenProvider jwtTokenProvider; //생성자에서 주입됨
...
//
//            //access재발급
//            String accessTokenValue = jwtTokenProvider.generateToken(Map.of("username", username), 1);
//
//            String refreshTokenValue = tokens.get("refreshToken");
//            //RefreshToken 기한이 3일 이내인 경우 -> 재발급
//            if(gapTime < (1000 * 60 * 60 * 24 * 3)) {
//                log.info("new refreshtoken generating....");
//                refreshTokenValue = jwtTokenProvider.generateToken(Map.of("username", username), 30);
//            }
//
...
//
//        try {
//            Map<String, Object> values = jwtTokenProvider.validateToken(refreshToken);
//            return values;
//        } catch (ExpiredJwtException expiredJwtException) {
